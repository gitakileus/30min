...
const Login = () => {
  ...
  const callbackUrlRedirect = url
    ...
    : (`/${router.locale}/user/profile` as string);
          ...
          <div className='bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10'>
            ...
            <div className='mt-6'>
              ...
              >
                ...
                <p className='text-base font-medium ml-4 text-gray-700'>Sign in with Facebook</p>
              </button>
              <button
                role='button'
                onClick={() =>
              ...
              >
                ...
                <p className='text-base font-medium ml-4 text-gray-700'>Sign in with Linkedin</p>
              </button>
            </div>
          </div>
        </div>
