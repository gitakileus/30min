...
const MemberListItem = ({member}) => {
  ...
  return (
    <li className='mt-4 grid overflow-hidden grid-cols-3 grid-rows-7 gap-2 grid-flow-row w-auto shadow-md overflow-y-auto'>
      ...
      <div className='box px-2 py-2 text-mainBlue col-span-2'>
        <div className='flex flex-row items-center'>
          ...
          {member?.personalDetails?.socials?.twitter && (
            <a href={member?.personalDetails?.socials?.twitter} rel='noreferrer' target='_blank'>
              <svg
                fill='currentColor'
                viewBox='0 0 24 24'
          ...
          {member?.personalDetails?.socials?.facebook && (
            <a href={member?.personalDetails?.socials?.facebook} target='_blank' rel='noreferrer'>
              <svg
                fill='currentColor'
                viewBox='0 0 24 24'
                className='w-5 h-5 sm:h-7 sm:w-7 text-mainBlue'
          ...
          {member?.personalDetails?.socials?.linkedin && (
            <a href={member?.personalDetails?.socials?.linkedin} target='_blank' rel='noreferrer'>
              <svg
          ...
          {member?.personalDetails?.socials?.instagram && (
            <a href={member?.personalDetails?.socials?.instagram} target='_blank' rel='noreferrer'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                aria-hidden='true'
                role='img'
          ...
          {member?.personalDetails?.socials?.youtube && (
            <a href={member?.personalDetails?.socials?.youtube} target='_blank' rel='noreferrer'>
              <svg
                xmlns='http://www.w3.org/2000/svg'
                aria-hidden='true'
                role='img'
